...
namespace OpenHome.Os.Apps
{
    ...
    public class AppInfo
    {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                result = (result*397) ^ (DownloadLastModified.HasValue ? DownloadLastModified.Value.GetHashCode() : 0);
                result = (result*397) ^ IsSystemApp.GetHashCode();
                return result;
            }
        }
    ...
    public class AppShellImpl : IDisposable
    {
        ...
        private bool UninstallByAppName(string aAppName, bool aUpdateHistory)
        {
            ...
            app.Delete();
            if (!app.DirectoryExists && !app.IsSystemApp)
            {
