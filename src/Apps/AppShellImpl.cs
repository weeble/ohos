...
namespace OpenHome.Os.Apps
{
    ...
    public class AppShellImpl : IDisposable
    {
        ...
        {
            InternalInstall(null, aPersistentZipFile, true, true);
        }

        public void InstallNew(string aPersistentZipFile)
        {
            InternalInstall(null, aPersistentZipFile, false, true);
        }

        public void Upgrade(string aAppName, string aZipFile)
        {
            InternalInstall(aAppName, aZipFile, true, false);
        }

        void InternalInstall(string aAppName, string aPersistentZipFile, bool aAllowUpgrade, bool aAllowInstall)
        {
